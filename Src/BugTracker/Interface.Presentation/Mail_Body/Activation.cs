...
namespace Interface.Presentation.Mail_Body
{
    public static class UserActivation
    {
        ...
        private static string SendTo(string mailTo)
        {
            ...
            string body =
                "<div>" +
                    "<div style=\"width: 85%;display: flex;justify-content: center;text-align: center;flex-direction: column;align-items: center;margin: 0 auto;background-color: #d4d8b4;\">" +
                        "<div style=\"background-image:url('http://localhost:58173/Content/Images/WebSite/logo-m.png');width: 170px;height: 231px;background-position: center;background-repeat: no-repeat;\"></div>" +
                            "<div style=\"background-image:url('http://localhost:58173/Content/Images/WebSite/banner.png');height: 230px;width: 850px;background-position: center;background-repeat: no-repeat;\"></div>" +
